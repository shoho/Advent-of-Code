...
class CrossedWires
	...
	def _move(direction,l)
		i = 1
		while i <= l
			@num_steps += 1
			@current_position = [self._getX + 1, self._getY] if direction == "R"
			@current_position = [self._getX - 1, self._getY] if direction == "L"
			@current_position = [self._getX, self._getY + 1] if direction == "U"
			@current_position = [self._getX, self._getY - 1] if direction == "D"

			@history.store(@num_steps, self._getCurrentPosition)
			i += 1
		end
	end
